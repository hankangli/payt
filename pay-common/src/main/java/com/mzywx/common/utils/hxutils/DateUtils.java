...
//	public static final String DATE_EXT_MINTIME = DbPropertyUtil.getValue("ext.minTime");
...
//		calendar.set(Calendar.SECOND, calendar.getMaximum(Calendar.SECOND));
        ...
        //这里取最大毫秒数，保存到数据库中会自动校正,数据库策略大于500毫秒的时间会默认加1秒,2019-06-26 09:18:53改为0毫秒
...
//		
     ...
     * 加减分钟
     *
     * @param num  正数：时间往后推num分钟；负数：往前推num分钟。
     * @param date
     * @return
     */
     ...
     * 加减秒
     *
     * @param num  正数：时间往后推num秒；负数：往前推num秒。
     * @param date
     * @return
     */
...
//		}
     ...
     * 获取距离本月加offset月的开始时间
     */
    public static Date getStartDateTimeOfMonthFromNow(int offset) {
        Calendar c = Calendar.getInstance();
     ...
     * 获取距离本月加offset月的结束时间
     */
    public static Date getEndDateTimeOfMonthFromNow(int offset) {
        Calendar c2 = Calendar.getInstance();
        c2.add(Calendar.MONTH, offset);
    ...
    /**
     * 描述：   把LocalDate类型转化为Date类型
     * 创建时间：2019年12月6日 下午2:20:04
     * 修改时间：2019年12月6日 下午2:20:04
     * 修改备注：
     *
     * @param localDate
     * @return
    ...
    public static Date localDate2Date(LocalDate localDate) {
        ChronoZonedDateTime<LocalDate> zonedDateTime = localDate.atStartOfDay(ZoneId.systemDefault());
    ...
    /**
     * 描述：   日期转化为localdate
     * 创建时间：2019年12月6日 下午3:10:11
     * 修改时间：2019年12月6日 下午3:10:11
     * 修改备注：
     *
     * @param date
     * @return
    ...
    /**
     * 描述：   校验字符串是否是指定的日期格式
     * 创建时间：2019年12月30日 下午10:03:45
     * 修改时间：2019年12月30日 下午10:03:45
     * 修改备注：
     *
     * @param dateStr
     * @param formatString
     ...
     * @version
     */
    public static boolean isValidDate(String dateStr, String formatString) {
     ...
     * @throws Exception
     */
    public static Date getYearBeginDate(Date date) throws Exception {
        Calendar c = Calendar.getInstance();
        if (date != null) {
            c.setTime(date);
        }
